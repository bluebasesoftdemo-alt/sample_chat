...
class SingleChatScreenss extends StatefulWidget {
  String? kUserName;
  String? kUserprofile;
  int? kUserid;
  String? kUserLoginStatus;
  String? kUserTimestamp;
  SingleChatScreenss({Key? key,required this.kUserName, required this.kUserid, required this.kUserprofile, required this.kUserLoginStatus, required this.kUserTimestamp}) : super(key: key);

  @override
  _SingleChatScreenssState createState() => _SingleChatScreenssState(kUserName,kUserid,kUserprofile,kUserLoginStatus,kUserTimestamp);
}

class _SingleChatScreenssState extends State<SingleChatScreenss> {
  bool show = false;
  ...
  String? kUserLoginStatus;
  String? kUserTimestamp;
  _SingleChatScreenssState(this.kUserName, this.kUserid, this.kUserprofile, this.kUserLoginStatus, this.kUserTimestamp);
  @override
  void initState() {
    super.initState();
    // connect();
