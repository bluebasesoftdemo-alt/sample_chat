  ...
  Widget build(BuildContext context) {
   // final otpcode =  Provider.of<OtpProvider>(context, listen: false);
    ...
    return Scaffold(
          ...
          body: Padding(padding: EdgeInsets.symmetric(horizontal: 20,vertical: 10),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                GestureDetector(
                  child:  Text(otpTextThree,style: GoogleFonts.poppins(
                      fontSize: 11,
                      color: Colors.green,
                ...
                SizedBox(height: 20,),
                CustomText.captionOne('Enter the verification code: $userotpcode here!', Colors.black),
                SizedBox(height: 10,),
                Center(
                  child: PinFieldAutoFill(
                      ...
                      decoration: BoxLooseDecoration(
                          strokeColorBuilder: PinListenColorBuilder(Colors.blueGrey, Colors.grey),//after/before
             ...
             /*   Consumer<OtpProvider>(builder: (_,timer,_){
                ...
                SizedBox(height: 10,),
                CustomButton(disabled:false, busy: false ,title: otpTextSeven,onTap: ()async{
          ...
          bottomNavigationBar: enable ? Container(height: 170,
            margin: EdgeInsets.symmetric(horizontal: 4.0),
            padding: EdgeInsets.all(10),
            decoration: BoxDecoration(
              boxShadow: [BoxShadow(color: SecondaryColor, blurRadius: 5, spreadRadius: 5,)],
            ...
            child:Column(
              children: [
                SizedBox(height: 20,),
                CustomFormField('Phone Number', false, false, false, true,txteditcntotpno),
                SizedBox(height: 20,),
