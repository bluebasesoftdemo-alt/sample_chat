      ...
      body: Center(
        child: Stack(
          ...
          children: [
            ...
            Positioned(
              bottom: MediaQuery.of(context).size.height * 0.518,
              child: SvgPicture.asset(
                splashImageTwo,
                width: MediaQuery.of(context).size.width,
              ),
            ...
            Positioned(
              ...
              left: 120,
              right: 120,
              child: SvgPicture.asset(splashImageThree),
            ),
            Positioned(
              left: 50,
              right: 50,
              ...
              child: Column(
                children: [
                  CustomText.headingFour(splashTextOne, Colors.white),
                  CustomText.headingFour(splashTextTwo, Colors.white),
                ],
              ),
            ),
